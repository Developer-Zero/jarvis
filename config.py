...
wake_word_threshold = 0.45 # sensitive 0-1 non-sensitive


# Speech recording
calibration_seconds = 0.6 # The recording will listen to the environment for this long to calibrate the noise floor
...
start_energy_multiplier = 2.0 # Multiplier for the noise_floor's volume to determine the start of speech
stop_energy_multiplier = 1.45 # Multiplier for the noise_floor's volume to determine the end of speech
