...
# Speech To Text
stt_mode = "openai" # * "openai", "whisper" (very bad quality, lot of ram usage, offline, free)
...
semantic_memory_top_k = 3 # Number of relevant memories injected into the agent context
...
episodic_memory_storage_mode = "summaries_only" # * "summaries_only", "events_and_summaries"
episodic_memory_summary_mode = "openai" # * "openai", "ollama"
episodic_memory_summary_model = "gpt-4o-mini" # * Summarizer model - "openai": "gpt-4o-mini" (default) or other gpt models listed above | "ollama": recommended: gemma3:1b
episodic_memory_top_k = 4 # Number of relevant episodic memories injected into the agent context
...
episodic_memory_summary_min_turns = 4 # Do not create a session summary until this many turns are buffered
episodic_memory_summary_every_turns = 5 # Refresh session summary after this many new turns
episodic_memory_summary_source_events = 20 # Number of recent buffered messages used to refresh the session summary

# Ducking
duck_percentage = 0.35 # Volume multiplier for other apps when Jarvis is listening and ducking is on. full mute 0.0-1.0 no ducking
